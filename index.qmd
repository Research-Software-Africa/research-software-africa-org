...
In 2022, [Liz Hare](https://twitter.com/DogGeneticsLLC) provided a [high-level accessibility report for the RSAA conference](RSEAUNZAccessibility.html) that we use as a benchmark for our performance. 
...
We will be using [the Code of Conduct from RSE-AUNZ for RSAfrica26](https://rse-aunz.github.io/code-of-conduct) at it is designed to provide all participants with community participation guidelines and create a safe space.
