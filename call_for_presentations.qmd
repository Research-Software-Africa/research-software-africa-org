---
title: "Call for Presentations – RSAfrica26"
format: html
---
...
**Conference dates:** 25-28 August 2026  

**Part of the Global South Research Software Group of Conferences**, under [Equersa](https://equersa.org)
...
Submissions should clearly describe what attendees will learn and how the presentation connects to research software practice or the research software community.
...
- Relevance to the RSAfrica26 theme  
...
Talks from first-time presenters, early-career RSEs, and those covering fundamental topics are encouraged. The conference welcomes diverse perspectives and aims to lower entry barriers for new speakers.


## Submission Timeline

- **CFP Opens:** April 15th, 2026 
- **Submission Deadline:** Extended to May 29th, 2026  
...
We encourage submissions from individuals of all backgrounds, disciplines, and career stages. RSAfrica26 is committed to creating an inclusive environment that values diverse perspectives and experiences.
...
- Avoid reliance on **colour alone** to convey information.
- Verbally describe important visual content where possible.

## Submission Process & Contact

Please [register](https://cmt3.research.microsoft.com/User/Register) for the Microsoft CMT submission platform. 

***Note:*** *All external profile information in the registration form is optional.*

For instructions on how to make a submission, see [instructions here](https://cmt3.research.microsoft.com/docs/help/author/author-submission-form.html).

For questions, please contact the RSAfrica26 Organising Committee at info@rseaa.org


[Submit Presentation for RSAfrica26!](https://cmt3.research.microsoft.com/RSAfrica2026/Submission/Index){.btn .btn-primary .btn-lg target="_blank" rel="noopener noreferrer"}
...
For more information, visit [https://research-software-africa.org](https://research-software-africa.org).
