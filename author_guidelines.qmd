...
- **10-minute Demo/Showcase** – A practical session to demonstrate tools, techniques, or workflows, offering practical insights or a quick tutorial.
...
***Note:*** *Non-presentation formats, such as posters, are not included in the current [Call for Presentations](https://www.research-software-africa.org/call_for_presentations.html).*

Each presentation should be **concise, engaging, and relevant to the conference theme: "Research Software Without Borders"**.

## 2. Submission Guidelines

Submissions must be made through the [RSAfrica26 online submission system](https://www.research-software-africa.org/call_for_presentations.html#submission-process-contact) by the [Call for Presentations closing deadline](https://www.research-software-africa.org/#key-dates-tentative).
...
- **Abstract:** 150–300 words summarising the content and its relevance to the theme.
...
- Inclusivity of the speaker(s) – Talks from first-time presenters, early-career RSEs, and those covering fundamental topics are encouraged.
...
- Avoid relying on **colour alone** to convey key information.
...
All presenters and attendees are expected to adhere to the **RSAfrica26 Code of Conduct**, which promotes **a respectful, inclusive, and harassment-free environment**. For 2026 [we are using the RSE-AUNZ Code of Conduct](https://rse-aunz.github.io/code-of-conduct).
...
For any questions or further assistance, please contact the **RSAfrica26 Organising Committee** at info@rseaa.org.
...
For updates and additional details, visit: <https://research-software-africa.org/>.
